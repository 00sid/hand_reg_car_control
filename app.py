...
from functions import pre_process_point_history
...
def main():
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                pre_processed_landmark_list = pre_process_landmark.pre_process_landmark(
                    landmark_list)
                pre_processed_point_history_list = pre_process_point_history.pre_process_point_history(
        ...
        # debug_image = draw_point_history.draw_point_history(debug_image, point_history)
